...
JD_CSV          = str(config.SCRAPED_JOBS_CSV) if config.SCRAPED_JOBS_CSV.exists() else "swe_jobs_india_all.csv"
OUTPUT_CSV      = str(config.MATCHED_JOBS_CSV)
OUTPUT_JSON     = str(config.TOP_MATCHES_JSON)
EMBEDDING_MODEL = config.EMBEDDING_MODEL
TOP_N           = config.TOP_N_MATCHES

CANDIDATE_YOE   = config.CANDIDATE_YOE
...
CANDIDATE_RESUME_TEXT = config.CANDIDATE_RESUME_TEXT
